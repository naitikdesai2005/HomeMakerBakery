...
//   return (
//     <aside className="w-50 min-h-screen bg-white border-r border-gray-200 shadow-sm transition-all duration-300 ease-in-out lg:w-60 md:w-56 sm:w-20">
//       <nav className="sticky top-0 pt-8 px-4">
...
//     <button
//       onClick={onClick}
//       className="w-full group relative flex items-center gap-3 px-4 py-3 text-gray-700 rounded-lg
//         transition-all duration-200 ease-in-out
//         hover:bg-gray-50 hover:text-gray-900 hover:shadow-sm
//         active:bg-gray-100
//         focus:outline-none focus:ring-2 focus:ring-gray-200 focus:bg-gray-50
...
//       <div className="absolute left-0 w-1 h-8 rounded-r-full bg-gray-800 transform scale-y-0 -translate-x-4
//         transition-transform duration-200 ease-out
//         group-hover:scale-y-100 group-hover:translate-x-0"
//       />
//     </button>
//   );
// };
